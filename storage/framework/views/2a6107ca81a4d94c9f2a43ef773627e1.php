...
<head>
    ...
    <title>TaskSync Pro — <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    <style>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('tasks.index')); ?>" class="nav-item <?php echo e(request()->routeIs('tasks.index') ? 'active' : ''); ?>">
            <span class="icon">📊</span> Dashboard
        </a>
        <a href="<?php echo e(route('tasks.create')); ?>" class="nav-item <?php echo e(request()->routeIs('tasks.create') ? 'active' : ''); ?>">
            <span class="icon">➕</span> New Task
        </a>
        <div class="nav-section-title" style="margin-top:16px;">Filters</div>
        <a href="<?php echo e(route('tasks.index', ['status' => 'Pending'])); ?>" class="nav-item">
            <span class="icon">⏳</span> Pending
        </a>
        <a href="<?php echo e(route('tasks.index', ['status' => 'Submitted'])); ?>" class="nav-item">
            <span class="icon">📤</span> Awaiting Approval
        </a>
        <a href="<?php echo e(route('tasks.index', ['status' => 'Approved'])); ?>" class="nav-item">
            <span class="icon">✅</span> Approved
        </a>
        <a href="<?php echo e(route('tasks.index', ['priority' => 'High'])); ?>" class="nav-item">
...
</html><?php /**PATH C:\laragon\www\myapp\resources\views/layouts/app.blade.php ENDPATH**/ ?>